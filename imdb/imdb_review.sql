...
CREATE TABLE `review` (
  `id` int NOT NULL,
  `ponit` int DEFAULT NULL,
  `reviewid` int DEFAULT NULL,
  `userid` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `reviewid` (`reviewid`),
  KEY `userid` (`userid`),
  CONSTRAINT `review_ibfk_1` FOREIGN KEY (`reviewid`) REFERENCES `review` (`id`),
...
INSERT INTO `review` VALUES (1,3,1,1),(2,5,1,1),(3,4,2,2),(4,2,2,2),(5,4,3,3),(6,4,3,3);
